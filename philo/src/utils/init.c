...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2025-04-26 09:40:42 by lalhindi          #+#    #+#             */
/*   Updated: 2025-04-26 09:40:42 by lalhindi         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
static int	init_args(t_data *d, int argc, char **argv)
{
	...
	if (argc == 6)
		...
		d->n_must_eat = -1;
	if (d->n_philos < 1 || d->t_die <= 0 || d->t_eat <= 0 || d->t_sleep <= 0
		|| (d->n_must_eat <= 0 && d->n_must_eat != -1))
	{
